...
│   ├── City_of_Mount_Hope_LOS.pdf
│   ├── Town_of_Thurmond_LOS.pdf
│   ├── WVU_LOS.pdf
│   └── Starry_Eyes_Media_LOS.pdf
└── referral_and_collaboration_materials/
    ├── WV_Community_Development_Hub_Pathway.md
    ├── WV_Grant_Resource_Centers_Referral.md
    ├── Legal_Readiness.md
    └── Higher_Education_Relationships.md
```

## Formal Agreement

### WV Hive / New River Gorge Regional Development Authority

Harmony for Hope has a signed client agreement with **WV Hive**, a program of the **New River Gorge Regional Development Authority**. This documented relationship provides an entrepreneurial and regional-development support pathway for Harmony for Hope’s work.

See: [`agreements/`](./agreements/)
...
## Referrals and Collaboration Pathways

### West Virginia Community Development Hub Pathway

Harmony for Hope has a working connection to the West Virginia Community Development Hub through the Preservation Alliance of West Virginia, the Fayette County Resource Coordinators Office, and regional-development guidance from Gabe Peña. This pathway has helped focus the project narrative on the connectivity mesh as the most practical first deployment.

### West Virginia Grant Resource Centers

Harmony for Hope was referred to the West Virginia Grant Resource Centers through the WV Hive support pathway. The Grant Resource Centers provide a grant-development and funding-navigation resource for the organization’s project planning.

### Legal Readiness

Harmony for Hope has an ongoing relationship with attorney **Tighe Bullock**. Legal support is anticipated to be available as funding permits, particularly for governance, agreements, compliance, and project documentation. This relationship is not presented as a funded legal-services agreement unless and until a written engagement is executed.
...
*This directory is maintained as a public-facing portfolio index. Before adding documents, Harmony for Hope reviews them for accuracy, privacy, permissions, and suitability for public release.*
